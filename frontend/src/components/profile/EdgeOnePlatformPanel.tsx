...
import { intelligenceOperation, searchMakersPlaces, workspaceOperation } from '../../app/apiComposition';
import { capabilityEnabled } from '../../services/skills';
import type { InstalledSkill, MakersMapPlace, ScheduleItem } from '../../shared/types';
