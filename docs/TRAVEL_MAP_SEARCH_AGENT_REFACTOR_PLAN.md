...
> **状态更新（2026-07-15）**：本文的 Phase 0–3 多数已由后续提交实现，部分“当前缺口”已经过时。最新事实和包含图片工作室、日历覆盖、论文助读与主动服务的统一计划见 [`CURRENT_ARCHITECTURE_AND_REFACTOR_PLAN.md`](CURRENT_ARCHITECTURE_AND_REFACTOR_PLAN.md)。
