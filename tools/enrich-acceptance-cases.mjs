...
const specialSteps = {
  ...
  'PRO-07': [
    ...
    '【浏览器】关闭目标应用的所有标签页；测试站可保持打开，因为它不会调用 /proactive-tick。',
    '【Makers 控制台】08:05 后进入日志分析，把时间范围设为 07:55—08:05，先筛选 /proactive-tick、来源 Cloud Functions，再筛选 /proactive、来源 Agents 和 2xx/5xx 状态。',
