"""Confirmed external side-effect providers; not an Agent route."""
...
async def generate_image(
    ...
    from ..makers.identity import required_user_id, tenant_storage_prefix

    storage_prefix = tenant_storage_prefix(required_user_id(user_id))
