...
def build_system_skill_tools(
    ...
    planned_route_calendar_stop_minutes: int = 0,
    ...
    plan_route_between_places = build_route_operation(
        ...
        planned_route_calendar_start_time=planned_route_calendar_start_time,
        planned_route_calendar_stop_minutes=planned_route_calendar_stop_minutes,
